            ...
            <body>
                ...
                <div class="container py-5 mt-5 mx-auto">
                    <div class="row g-4 mb-5 mt-3">
                        ...
                        <div class="row g-4 fruite justify-content-center">
                                            ...
                                            <div class="rounded position-relative fruite-item">
                                                <div class="fruite-img">
                                                    <img src="/images/product/${product.image}"
                                                        ...
                                                        style="width: 306px; height: 306px; object-fit: cover;">
                                                </div>
                                        ...
                                        <nav aria-label="Page navigation example">
                                            <ul class="pagination d-flex justify-content-center">
                                                <li class="${currentPage eq 1 ? 'disabled page-item' : 'page-item'}">
                                                    <a class="page-link"
                                                        href="/client/product/show?page=${currentPage - 1}${queryString}"
                                                        aria-label="Previous">
                                                ...
                                                <c:forEach begin="1" end="${totalPages}" varStatus="loop">
                                                    <li class="page-item"><a
                                                            ...
                                                            href="/client/product/show?page=${loop.index}${queryString}">
